...
<html lang="en">
  ...
  <body>
    ...
    <header class="header__bannerGray">
      <img src="../img/noproblem_logo.svg" alt="logo" class="header__bannerGray-logo">
    </header>
    ...
    <main>
      ...
      <section class="product__section-banner u-margin-bottom-medium underNav">
        <div class="banner">
          <a href="#">
            <img src="../img/product/d3-02-min.jpg" alt="" class="banner__img" />
          </a>
        </div>
      </section>
      ...
      <?php
include 'getItem.php';
getProductSection('./img/item/tshirt_no0020/','seemore');
getProductSection('./img/item/tshirt_ov101/','seemore');
getProductSection('./img/item/tshirt_no0029/','seemore');
getProductSection('./img/item/tshirt_ov/','seemore');
getProductSection('./img/item/polo_ns5000/','seemore');
getProductSection('./img/item/polo_no5000/','seemore');
